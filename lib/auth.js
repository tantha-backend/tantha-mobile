...
import { getAppleCredential } from "./appleAuth";
...
export const AuthProvider = ({ children }) => {
  ...
  const value = useMemo(
    () => ({
      ...
      /**
       * Signs in with Apple. Same contract as Google: null means the sheet
       * was dismissed, which is not an error.
       */
      signInWithApple: async () => {
        ...
        const res = await authService.apple(
